          ...
          children: [
            ...
            Padding(
              ...
              child: InkWell(
                ...
                onTap: () async {
                  logFirebaseEvent('WEBVIEW_COMP_Row_ycl59xpt_ON_TAP');
            ...
            Padding(
              ...
              child: InkWell(
                ...
                highlightColor: Colors.transparent,
                onTap: () async {
                  logFirebaseEvent('WEBVIEW_COMP_Row_qfof2jtp_ON_TAP');
                  logFirebaseEvent('Row_navigate_to');
            ...
            Padding(
              ...
              child: InkWell(
                ...
                highlightColor: Colors.transparent,
                onTap: () async {
                  logFirebaseEvent('WEBVIEW_COMP_Row_9rw83rhl_ON_TAP');
                  logFirebaseEvent('Row_navigate_to');
            ...
            Padding(
              ...
              child: InkWell(
                ...
                highlightColor: Colors.transparent,
                onTap: () async {
                  logFirebaseEvent('WEBVIEW_COMP_Row_3ia79oel_ON_TAP');
                  logFirebaseEvent('Row_navigate_to');
            ...
            Padding(
              ...
              child: InkWell(
                ...
                highlightColor: Colors.transparent,
                onTap: () async {
                  logFirebaseEvent('WEBVIEW_COMP_Row_hdd2o63x_ON_TAP');
                  logFirebaseEvent('Row_navigate_to');
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  '3c9bpohg' /* Having trouble with our applic... */,
                                ),
                        ...
                        children: [
                          if (Theme.of(context).brightness == Brightness.light)
                            InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'WEBVIEW_COMP_isLightMode_ON_TAP');
                                logFirebaseEvent(
                          ...
                          if (Theme.of(context).brightness == Brightness.dark)
                            InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'WEBVIEW_COMP_isDarkMode_ON_TAP');
                                logFirebaseEvent(
