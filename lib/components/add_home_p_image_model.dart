...
class AddHomePImageModel extends FlutterFlowModel {
  ...
  String? _buttonTextControllerValidator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'zzpeotzw' /* Field is required */,
      );
    }
  ...
  // Stores action output result for [Custom Action - updateHomeImage] action in Button widget.
  DocumentReference? refImageHome;
  ...
  void initState(BuildContext context) {
    buttonTextControllerValidator = _buttonTextControllerValidator;
  }
