...
class _AddProductWidgetState extends State<AddProductWidget>
  ...
  void initState() {
    ...
    _model.productInfoController ??= TextEditingController();
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                              ...
                                              children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'p4yqasyf' /* Please enter the information b... */,
                                                    ),
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .labelMedium,
                                          ...
                                          FlutterFlowIconButton(
                                            ...
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'ADD_PRODUCT_close_rounded_ICN_ON_TAP');
                                              logFirebaseEvent(
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'ADD_PRODUCT_COMP_heroImage_ON_TAP');
                                              logFirebaseEvent(
                                        ...
                                        children: [
                                          Text(
                                            FFLocalizations.of(context).getText(
                                              'qh6li9s9' /* Please upload an image! */,
                                            ),
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            return FlutterFlowDropDown<String>(
                                              ...
                                              hintText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                '5w659el6' /* Please select a brand.. */,
                                              ),
                                              icon: Icon(
                                                Icons
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            return FlutterFlowDropDown<String>(
                                              ...
                                              hintText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                '9r6opurl' /* Please select a sub category.. */,
                                              ),
                                              icon: Icon(
                                                Icons
                                                    .keyboard_arrow_down_rounded,
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'vh3gfkok' /* Please complete the all data s... */,
                                              ),
                                              style: FlutterFlowTheme.of(
                                                      context)
                                                  .bodyMedium
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: FFButtonWidget(
                                              onPressed: () async {
                                                logFirebaseEvent(
                                                    'ADD_PRODUCT_COMP_CANCEL_BTN_ON_TAP');
                                                logFirebaseEvent(
                                                    'Button_bottom_sheet');
                                                Navigator.pop(context);
                                              },
                                          ...
                                          Padding(
                                            ...
                                            child: FFButtonWidget(
                                              onPressed: () async {
                                                logFirebaseEvent(
                                                    'ADD_PRODUCT_COMP_CREATE_BTN_ON_TAP');
                                                ...
                                                try {
                                                  ...
                                                  if (_model.imageUrl != null &&
                                                    ...
                                                    if ((_model.brandValue !=
                                                      ...
                                                      _model.idDiscount = DiscountsRecord
                                                          .getDocumentFromData(
                                                              createDiscountsRecordData(
                                                                active: false,
                                                              ),
                                                      ...
                                                      _model.idproduct = ProductRecord
                                                          .getDocumentFromData(
                                                              createProductRecordData(
                                                                name: _model
                                                                    .productNameController
                                                      ...
                                                      ScaffoldMessenger.of(
                                                        ...
                                                        SnackBar(
                                                          content: Text(
                                                            'Create a product with sucess! Please add variants.',
                                                            style: TextStyle(
                                                              color: FlutterFlowTheme
                                                                      .of(context)
                                                                  .primary,
