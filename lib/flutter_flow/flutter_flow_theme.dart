...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color warning = const Color(0xC6FFFFFF);
  late Color error = const Color(0xFFE21C3D);
  late Color info = const Color(0xFF1C4494);

  late Color primaryBtnText = Color(0xFFFFFFFF);
  late Color lineColor = Color(0xFF6E61FA);
  late Color noaktive = Color(0xFF757575);
  late Color searchColor = Color(0xFFEDEDED);
  late Color primaryHex = Color(0xC0FFFFFF);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color success = const Color(0xFF04A24C);
  late Color warning = const Color(0xB4000000);
  late Color error = const Color(0xFFE21C3D);
  late Color info = const Color(0xFF1C4494);
  ...
  late Color noaktive = Color(0xFF757575);
  late Color searchColor = Color(0xFFEDEDED);
  late Color primaryHex = Color(0xB4000000);
}
