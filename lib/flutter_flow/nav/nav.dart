...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? HomeWidget() : InitialPageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'shopSubCategories',
              builder: (context, params) => ShopSubCategoriesWidget(
            ...
            FFRoute(
              name: 'ListProducts',
              path: 'listProducts',
              builder: (context, params) => ListProductsWidget(
                subcategoryref: params.getParam(
                    'subcategoryref',
            ...
            FFRoute(
              name: 'Product_Item',
              path: 'productItem',
              builder: (context, params) => ProductItemWidget(
                productref: params.getParam('productref',
                    ParamType.DocumentReference, false, ['product']),
                imageRef: params.getParam('imageRef', ParamType.String),
                colorId: params.getParam(
                    'colorId', ParamType.DocumentReference, false, ['colors']),
              ),
            ),
            FFRoute(
              name: 'AuthPage',
            ...
            FFRoute(
              name: 'ProfileTeam',
              path: 'profileTeam',
              builder: (context, params) => ProfileTeamWidget(),
            ),
            FFRoute(
              name: 'SearchPage',
              path: 'searchPage',
            ...
            FFRoute(
              ...
              path: 'dashbordAdmin',
              requireAuth: true,
              builder: (context, params) => DashbordAdminWidget(),
            ),
            FFRoute(
              name: 'ManageProducts',
              path: 'manageProducts',
            ...
            FFRoute(
              ...
              path: 'manageTeams',
              requireAuth: true,
              builder: (context, params) => ManageTeamsWidget(),
            )
